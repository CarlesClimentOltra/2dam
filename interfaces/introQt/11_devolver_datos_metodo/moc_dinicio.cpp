...
QT_MOC_LITERAL(3, 26, 24), // "slotAceptarTransferencia"
QT_MOC_LITERAL(4, 51, 25), // "slotCancelarTransferencia"
QT_MOC_LITERAL(5, 77, 14), // "slotActualizar"
QT_MOC_LITERAL(6, 92, 33), // "slotTransferenciaCantidadAcep..."
QT_MOC_LITERAL(7, 126, 33) // "slotTransferenciaCompletaAcep..."

    },
    "DInicio\0slotAbrirDialogo\0\0"
    "slotAceptarTransferencia\0"
    "slotCancelarTransferencia\0slotActualizar\0"
    "slotTransferenciaCantidadAceptada\0"
    "slotTransferenciaCompletaAceptada"
};
...
void DInicio::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->slotAceptarTransferencia(); break;
        case 2: _t->slotCancelarTransferencia(); break;
        case 3: _t->slotActualizar(); break;
        case 4: _t->slotTransferenciaCantidadAceptada((*reinterpret_cast< float(*)>(_a[1]))); break;
        case 5: _t->slotTransferenciaCompletaAceptada((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< float(*)>(_a[2]))); break;
        default: ;
        }
    }
}
