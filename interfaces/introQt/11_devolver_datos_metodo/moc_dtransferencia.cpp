...
QT_MOC_LITERAL(3, 44, 27), // "senyalTransferenciaCompleta"
QT_MOC_LITERAL(4, 72, 19), // "slotActualizarBoton"
QT_MOC_LITERAL(5, 92, 22), // "slotActualizarComision"
QT_MOC_LITERAL(6, 115, 11) // "slotAceptar"

    },
    "DTransferencia\0senyalTransferenciaOrdenada\0"
    "\0senyalTransferenciaCompleta\0"
...
void DTransferencia::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->senyalTransferenciaCompleta((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< float(*)>(_a[2]))); break;
        ...
        {
            using _t = void (DTransferencia::*)(QString , float );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DTransferencia::senyalTransferenciaCompleta)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void DTransferencia::senyalTransferenciaCompleta(QString _t1, float _t2)
{
